...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilterSelect = __webpack_require__(163);
	var CountriesBox = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(CountryDisplay, { countryToDisplay: this.state.currentCountry, countries: this.state.countries, setCurrentCountry: this.setCurrentCountry })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CountryDisplay = React.createClass({
	  ...
	  render: function render() {
	    if (!this.props.countryToDisplay) {
	      return React.createElement(
	        'h4',
	        null,
	        'No Country Selected'
	    ...
	    return React.createElement(
	      ...
	      React.createElement(BorderDisplay, { countryWithBorders: this.props.countryToDisplay, key: this.props.countryToDisplay.alpha3Code, countries: this.props.countries, setCurrentCountry: this.props.setCurrentCountry })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BorderDisplay = React.createClass({
	  ...
	  handleBorderClick: function handleBorderClick(event) {
	    event.preventDefault();
	  ...
	  render: function render() {
	    var borders = this.props.countryWithBorders.borders.map(function (border, index) {
	      return React.createElement(
	        ...
	        React.createElement(
	          'a',
	          { href: '#', onClick: this.handleBorderClick },
	          border
	        ),
	        ' '
	      );
